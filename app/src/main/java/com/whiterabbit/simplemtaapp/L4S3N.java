 ...
 */
public class L4S3N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Bedford Park Boulevard-Lehman College");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L4S3S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L4S3N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L4S3N");	//Uptown
                return datalist; }else{
                return ReadArrayListFromSD(L4S3N.this,"L4S3N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L4S3N.this,"L4S3N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L4S3N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L4S3N.this,R.layout.listviewlayout,list1 );

 ...
 */
public class L6S18N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("3 Avenue-138 Street");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L6S18S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L6S18N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L6S18N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L6S18N.this,"L6S18N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L6S18N.this,"L6S18N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L6S18N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L6S18N.this,R.layout.listviewlayout,list1 );

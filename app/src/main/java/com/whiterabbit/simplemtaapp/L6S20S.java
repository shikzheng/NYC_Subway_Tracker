 ...
 */
public class L6S20S extends AppCompatActivity {
    ...
    private void North(){
        startActivity(new Intent("com.example.android.nycsubway.L6S20N"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private ProgressDialog progDailog = new ProgressDialog(L6S20S.this);
        ...
        protected ArrayList<String> doInBackground(Void... arg0){
            ...
            try {
                ...
                deleteFile("L6S20S");	//Downtown
            return datalist;}else{
                return ReadArrayListFromSD(L6S20S.this,"L6S20S");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L6S20S.this,"L6S20S",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L6S20S.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L6S20S.this, R.layout.listviewlayout, list1);

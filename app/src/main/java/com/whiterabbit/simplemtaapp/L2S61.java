 ...
 */
public class L2S61 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Flatbush Avenue-Brooklyn College");
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            case R.id.refreshlast:
                finish();
                startActivity(getIntent());
                break;
            case R.id.station1ast:
                Station1();
                break;
        }
        return true;
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L2S61.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                for (GtfsRealtime.FeedEntity entity : feed.getEntityList()) {
                    if(entity.getTripUpdate().getTrip().getRouteId().equals("2")){
                        for (GtfsRealtime.TripUpdate.StopTimeUpdate stu : entity.getTripUpdate().getStopTimeUpdateList()) {
                            if(stu.getStopId().equals("247N")){
                                Date date = new Date(stu.getDeparture().getTime() * 1000);
                ...
                deleteFile("L2S61");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L2S61.this,"L2S61");
            }
        }
        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L2S61.this,"L2S61",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L2S61.this);
            tv.setText("Departure Time(Uptown)");
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L2S61.this,R.layout.listviewlayout,list1 );

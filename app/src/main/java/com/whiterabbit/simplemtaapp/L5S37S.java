 ...
 */
public class L5S37S extends AppCompatActivity {
    ...
    private void North(){
        startActivity(new Intent("com.example.android.nycsubway.L5S37N"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private ProgressDialog progDailog = new ProgressDialog(L5S37S.this);
        ...
        protected ArrayList<String> doInBackground(Void... arg0){
            ...
            try {
                ...
                deleteFile("L5S37S");	//Downtown
            return datalist;}else{
                return ReadArrayListFromSD(L5S37S.this,"L5S37S");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L5S37S.this,"L5S37S",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L5S37S.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L5S37S.this, R.layout.listviewlayout, list1);

 ...
 */
public class L1S4N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Marble Hill-225 Street");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L1S4S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L1S4N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            if (mWifi.isConnected()) {
                ...
                return ReadArrayListFromSD(L1S4N.this,"L1S4N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {
            SaveArrayListToSD(L1S4N.this,"L1S4N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L1S4N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L1S4N.this,R.layout.listviewlayout,list1 );

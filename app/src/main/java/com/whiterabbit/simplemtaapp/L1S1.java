 ...
 */
public class L1S1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Van Cortlandt Park-242 Street");
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L1S1.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            if (mWifi.isConnected()) {
                ...
                return ReadArrayListFromSD(L1S1.this,"L1S1");
            }
        }

        protected void onPostExecute(ArrayList<String> list1){
            SaveArrayListToSD(L1S1.this,"L1S1",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L1S1.this);
            tv.setText("Departure Time(Downtown)");
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L1S1.this,R.layout.listviewlayout,list1 );

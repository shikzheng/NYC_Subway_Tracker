 ...
 */
public class L2S56N extends AppCompatActivity {
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L2S56S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L2S56N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L2S56N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L2S56N.this,"L2S56N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L2S56N.this,"L2S56N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L2S56N.this);
            tv.setText("Arrival Time(Uptown)");
            tv.setTextColor(Color.WHITE);
            tv.setGravity(Gravity.CENTER);
            tv.setTextSize(20);
            tv.setBackgroundResource(R.drawable.btn_blue);
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L2S56N.this,R.layout.listviewlayout,list1 );

 ...
 */
public class L2S1 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Wakefield-241 Street");
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L2S1.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            if (mWifi.isConnected()) {
                ...
                deleteFile("L2S1");	//Downtown
                return datalist;
            }else{
                return ReadArrayListFromSD(L2S1.this,"L2S1");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {
            SaveArrayListToSD(L2S1.this,"L2S1",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L2S1.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L2S1.this,R.layout.listviewlayout,list1 );

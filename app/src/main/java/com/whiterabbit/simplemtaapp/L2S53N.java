 ...
 */
public class L2S53N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Eastern Parkway-Brooklyn Museum");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L2S53S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L2S53N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L2S53N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L2S53N.this,"L2S53N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L2S53N.this,"L2S53N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L2S53N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L2S53N.this,R.layout.listviewlayout,list1 );

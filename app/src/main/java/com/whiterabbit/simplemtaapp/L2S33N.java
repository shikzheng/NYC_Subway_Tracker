 ...
 */
public class L2S33N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("34 Street-Penn Station");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L2S33S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L2S33N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L2S33N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L2S33N.this,"L2S33N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L2S33N.this,"L2S33N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L2S33N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L2S33N.this,R.layout.listviewlayout,list1 );

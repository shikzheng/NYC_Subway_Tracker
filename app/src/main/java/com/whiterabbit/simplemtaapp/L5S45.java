 ...
 */
public class L5S45 extends AppCompatActivity {
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L5S45.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                for (GtfsRealtime.FeedEntity entity : feed.getEntityList()) {
                    if(entity.getTripUpdate().getTrip().getRouteId().equals("5")){
                ...
                deleteFile("L5S45");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L5S45.this,"L5S45");
            }
        }
        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L5S45.this,"L5S45",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L5S45.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L5S45.this,R.layout.listviewlayout,list1 );

 ...
 */
public class L2S30S extends AppCompatActivity {
    ...
    private void North(){
        startActivity(new Intent("com.example.android.nycsubway.L2S30N"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L2S30S.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L2S30S");	//Downtown
            return datalist;}else{
                return ReadArrayListFromSD(L2S30S.this,"L2S30S");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L2S30S.this,"L2S30S",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L2S30S.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L2S30S.this,R.layout.listviewlayout,list1 );

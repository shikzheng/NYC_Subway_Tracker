 ...
 */
public class L3S34 extends AppCompatActivity {
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L3S34.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L3S34");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L3S34.this,"L3S34");
            }
        }
        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L3S34.this,"L3S34",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L3S34.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L3S34.this,R.layout.listviewlayout,list1 );

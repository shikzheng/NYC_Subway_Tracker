 ...
 */
public class L6S13N extends AppCompatActivity {
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L6S13S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L6S13N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L6S13N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L6S13N.this,"L6S13N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L6S13N.this,"L6S13N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L6S13N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L6S13N.this,R.layout.listviewlayout,list1 );

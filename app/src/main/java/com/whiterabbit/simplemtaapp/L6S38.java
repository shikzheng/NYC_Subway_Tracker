 ...
 */
public class L6S38 extends AppCompatActivity {
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L6S38.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L6S38");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L6S38.this,"L6S38");
            }
        }
        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L6S38.this,"L6S38",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L6S38.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L6S38.this,R.layout.listviewlayout,list1 );

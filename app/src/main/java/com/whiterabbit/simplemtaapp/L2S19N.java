 ...
 */
public class L2S19N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("3 Avenue-149 Street");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L2S19S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L2S19N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L2S19N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L2S19N.this,"L2S19N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L2S19N.this,"L2S19N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L2S19N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L2S19N.this,R.layout.listviewlayout,list1 );

 ...
 */
public class L1S37 extends AppCompatActivity {
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L1S37.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            if (mWifi.isConnected()) {
                ...
                deleteFile("L1S37");	//Uptown
                return datalist;
            }else{
                return ReadArrayListFromSD(L1S37.this,"L1S37");
            }
        }
        protected void onPostExecute(ArrayList<String> list1) {
            SaveArrayListToSD(L1S37.this,"L1S37",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L1S37.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L1S37.this,R.layout.listviewlayout,list1 );

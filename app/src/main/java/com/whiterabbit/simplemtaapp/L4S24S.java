 ...
 */
public class L4S24S extends AppCompatActivity {
    ...
    private void North(){
        startActivity(new Intent("com.example.android.nycsubway.L4S24N"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private ProgressDialog progDailog = new ProgressDialog(L4S24S.this);
        ...
        protected ArrayList<String> doInBackground(Void... arg0){
            ...
            try {
                ...
                deleteFile("L4S24S");	//Downtown
            return datalist;}else{
                return ReadArrayListFromSD(L4S24S.this,"L4S24S");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L4S24S.this,"L4S24S",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L4S24S.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L4S24S.this, R.layout.listviewlayout, list1);

 ...
 */
public class L4S54 extends AppCompatActivity {
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L4S54.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L4S54");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L4S54.this,"L4S54");
            }
        }
        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L4S54.this,"L4S54",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L4S54.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L4S54.this,R.layout.listviewlayout,list1 );

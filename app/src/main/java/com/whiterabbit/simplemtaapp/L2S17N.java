 ...
 */
public class L2S17N extends AppCompatActivity {
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L2S17S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L2S17N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            if (mWifi.isConnected()) {
                ...
                deleteFile("L2S17N");	//Uptown
                return datalist;
            }else{
                return ReadArrayListFromSD(L2S17N.this,"L2S17N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L2S17N.this,"L2S17N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L2S17N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L2S17N.this,R.layout.listviewlayout,list1 );

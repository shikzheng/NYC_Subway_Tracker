 ...
 */
public class L1S28N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("23 Street");       //<---------------CHANGE THIS!!!!!!!!!!
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L1S28S"));                    //<---------------CHANGE THIS!!!!!!!!!!
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L1S28N.this);             //<---------------CHANGE THIS!!!!!!!!!!
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            if (mWifi.isConnected()) {
                    ...
                    for (GtfsRealtime.FeedEntity entity : feed.getEntityList()) {
                        if (entity.getTripUpdate().getTrip().getRouteId().equals("1")) {
                            for (GtfsRealtime.TripUpdate.StopTimeUpdate stu : entity.getTripUpdate().getStopTimeUpdateList()) {
                                if (stu.getStopId().equals("130N")) {                              //<---------------CHANGE THIS!!!!!!!!!!
                ...
                deleteFile("L1S28N");	//Uptown
                return datalist;
            }else{
                return ReadArrayListFromSD(L1S28N.this,"L1S28N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {
            SaveArrayListToSD(L1S28N.this,"L1S28N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L1S28N.this);                       //<---------------CHANGE THIS!!!!!!!!!!
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L1S28N.this,R.layout.listviewlayout,list1 );             //<---------------CHANGE THIS!!!!!!!!!!

 ...
 */
public class L1S15S extends AppCompatActivity {
    ...
    private void North(){
        startActivity(new Intent("com.example.android.nycsubway.L1S15N"));                    //<---------------CHANGE THIS!!!!!!!!!!
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L1S15S.this);                 //<---------------CHANGE THIS!!!!!!!!!!
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            if (mWifi.isConnected()) {
                    ...
                    for (GtfsRealtime.FeedEntity entity : feed.getEntityList()) {
                        if (entity.getTripUpdate().getTrip().getRouteId().equals("1")) {
                            for (GtfsRealtime.TripUpdate.StopTimeUpdate stu : entity.getTripUpdate().getStopTimeUpdateList()) {
                                if (stu.getStopId().equals("117S")) {                  //<---------------CHANGE THIS!!!!!!!!!!
                ...
                deleteFile("L1S15S");	//Downtown
                return datalist;
            }else{
                return ReadArrayListFromSD(L1S15S.this,"L1S15S");
            }
        }

        protected void onPostExecute(ArrayList<String> list1){
            SaveArrayListToSD(L1S15S.this,"L1S15S",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L1S15S.this);           //<---------------CHANGE THIS!!!!!!!!!!
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L1S15S.this,R.layout.listviewlayout,list1 );         //<---------------CHANGE THIS!!!!!!!!!!

 ...
 */
public class L6S9N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Morrison-Sound View Avenues");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L6S9S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L6S9N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L6S9N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L6S9N.this,"L6S9N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L6S9N.this,"L6S9N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L6S9N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L6S9N.this,R.layout.listviewlayout,list1 );

 ...
 */
public class L5S3N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Gun Hill Road/Seymour Avenue");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L5S3S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L5S3N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L5S3N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L5S3N.this,"L5S3N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L5S3N.this,"L5S3N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L5S3N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L5S3N.this,R.layout.listviewlayout,list1 );

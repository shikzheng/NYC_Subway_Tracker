 ...
 */
public class L4S34N extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        this.setTitle("Brooklyn Bridge-City Hall");
    ...
    private void South(){
        startActivity(new Intent("com.example.android.nycsubway.L4S34S"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private  ProgressDialog progDailog = new ProgressDialog(L4S34N.this);
        ...
        protected ArrayList<String> doInBackground(Void...arg0){
            ...
            try {
                ...
                deleteFile("L4S34N");	//Uptown
            return datalist;}else{
                return ReadArrayListFromSD(L4S34N.this,"L4S34N");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L4S34N.this,"L4S34N",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L4S34N.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L4S34N.this,R.layout.listviewlayout,list1 );

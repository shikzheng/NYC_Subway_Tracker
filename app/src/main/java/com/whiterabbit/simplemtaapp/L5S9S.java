 ...
 */
public class L5S9S extends AppCompatActivity {
    ...
    private void North(){
        startActivity(new Intent("com.example.android.nycsubway.L5S9N"));
    }
    ...
    private class AsyncTaskData extends AsyncTask<Void, Void, ArrayList<String>> {
        private ProgressDialog progDailog = new ProgressDialog(L5S9S.this);
        ...
        protected ArrayList<String> doInBackground(Void... arg0){
            ...
            try {
                ...
                deleteFile("L5S9S");	//Downtown
            return datalist;}else{
                return ReadArrayListFromSD(L5S9S.this,"L5S9S");
            }
        }

        protected void onPostExecute(ArrayList<String> list1) {SaveArrayListToSD(L5S9S.this,"L5S9S",list1);
            ListView lv;
            progDailog.dismiss();
            lv = (ListView) findViewById(R.id.l1s1list);
            TextView tv;
            tv = new TextView(L5S9S.this);
            ...
            lv.addHeaderView(tv);
            ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(L5S9S.this, R.layout.listviewlayout, list1);
